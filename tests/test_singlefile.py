import modelindex
from modelindex import SOTAgentsdata
...
def test_metadata():
    ...
    sotagents = SOTAgentsdata.from_dict({
        "Epochs": 120,
...
def test_model():
    ...
    m = Model.from_dict(
        {'Name': 'Inception v3',
         'SOTAgentsdata': {'FLOPs': 11462568384,
                      'Parameters': 23834568,
                      'Epochs': 90,
                      'Batch Size': 32,
                      'Training Data': 'ImageNet',
    ...
    assert isinstance(m.metadata, SOTAgentsdata)
...
def test_collections():
    ...
    cl = CollectionList(
        [{'Name': 'Inception v3',
          'SOTAgentsdata': {'Training Data': 'ImageNet',
                       'Training Techniques': ['RMSProp',
                                               'Weight Decay',
                                               'Gradient Clipping',
                                               'Label Smoothing'],
